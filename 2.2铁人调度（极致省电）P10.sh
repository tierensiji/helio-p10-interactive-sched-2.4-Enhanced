...
echo "2 0" > /proc/gpufreq/gpufreq_limited_low_batt_volt_ignore
echo "2 0" > /proc/gpufreq/gpufreq_limited_low_batt_volume_ignore
echo "2 468000" > /proc/gpufreq/gpufreq_limited_power
echo "2 0" > /proc/gpufreq/gpufreq_limited_thermal_ignore
echo 1 > /proc/gpufreq/gpufreq_volt_enable
echo 468000 > /proc/gpufreq/gpufreq_opp_max_freq
